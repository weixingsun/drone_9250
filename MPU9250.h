...
#define WHO_AM_I_AK8963  0x00   //Mario: change 0x49 for 0x00 // (AKA WIA) should return 0x48
#define INFO             0x01
...
public:
  ...
  public:
    ...
    uint16_t magCount[3];    // Stores the 16-bit signed magnetometer sensor output
