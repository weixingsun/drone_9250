...
void MPU6050::initAK8963(float * destination)
{
...
{  
 ...
 // Range selects FS_SEL and AFS_SEL are 0 - 3, so 2-bit values are left-shifted into positions 4:3
  uint8_t c = readByte(MPU6050_ADDRESS, GYRO_CONFIG); // get current GYRO_CONFIG register value
 ...
 // Set accelerometer full-scale range configuration
  c = readByte(MPU6050_ADDRESS, ACCEL_CONFIG); // get current ACCEL_CONFIG register value
 // c = c & ~0xE0; // Clear self-test bits [7:5] 
  c = c & ~0x18;  // Clear AFS bits [4:3]
 ...
 // accel_fchoice_b bit [3]; in this case the bandwidth is 1.13 kHz
  c = readByte(MPU6050_ADDRESS, ACCEL_CONFIG2); // get current ACCEL_CONFIG2 register value
